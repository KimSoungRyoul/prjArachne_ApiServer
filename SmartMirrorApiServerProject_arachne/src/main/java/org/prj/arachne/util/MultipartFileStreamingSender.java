 ...
 */
public class MultipartFileStreamingSender {
	...
	public MultipartFileStreamingSender() {
	}

	public static MultipartFileStreamingSender fromPath(Path path) {
		return new MultipartFileStreamingSender().setFilepath(path);
	}

	public static MultipartFileStreamingSender fromFile(File file) {
		return new MultipartFileStreamingSender().setFilepath(file.toPath());
	}

	public static MultipartFileStreamingSender fromURIString(String uri) {
		return new MultipartFileStreamingSender().setFilepath(Paths.get(uri));
	}

	// ** internal setter **//
	private MultipartFileStreamingSender setFilepath(Path filepath) {
		this.filepath = filepath;
		return this;
	}

	public MultipartFileStreamingSender with(HttpServletRequest httpRequest) {
		request = httpRequest;
		return this;
	}

	public MultipartFileStreamingSender with(HttpServletResponse httpResponse) {
